...
// node_modules/vue3-social-sharing/dist/index.js
var l = {
...
var d = (e) => Object.entries(e).map(([t, r]) => r ? `${t}=${r}` : "").filter((t) => t).join(",");
var h2 = (e) => {
  if (!i())
    return null;
...
var g = (e, t) => t === "facebook" && e && e.length > 0 ? `%23${e.split(",")[0]}` : e;
var f = () => ({
  network: "",
  url: "",
  title: "",
...
var k = (e) => {
  ...
  return Object.fromEntries(Object.keys(t).map((r) => {
    let s = toValue(e[r]) || t[r];
    return s = r === "hashtags" ? g(s, r) : encodeURIComponent(s), [r, s];
  }));
};
var b = (e, t) => e.replace(/@tu/g, t.twitterUser).replace(/@u/g, t.url).replace(/@t/g, t.title).replace(/@d/g, t.description).replace(/@q/g, t.quote).replace(/@h/g, t.hashtags).replace(/@m/g, t.media);
var v = () => {
  const e = Object.assign({}, l, inject("share-networks", {})), t = (s) => {
    const n = k(s);
...
var y = defineComponent({
  ...
  setup(e, t) {
    const { shareLink: r } = v();
    return () => t.slots.default ? t.slots.default({ share: () => r(e) }) : h("div", { onClick: () => r(e) }, "Share");
  }
});
var x = {
  install(e, t = {}) {
...
//# sourceMappingURL=vue3-social-sharing.js.map
