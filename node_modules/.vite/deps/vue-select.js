...
var C = (e, t, s) => t in e ? E(e, t, { enumerable: true, configurable: true, writable: true, value: s }) : e[t] = s;
var f = (e, t) => {
  for (var s in t || (t = {}))
...
var he = ["dir"];
var ce = ["id", "aria-expanded", "aria-owns"];
var ue = {
  ref: "selectedOptions",
  class: "vs__selected-options"
};
var pe = ["disabled", "title", "aria-label", "onClick"];
var fe = {
  ref: "actions",
  class: "vs__actions"
};
var ge = ["disabled"];
var ye = { class: "vs__spinner" };
var me = ["id"];
var be = ["id", "aria-selected", "onMouseover", "onClick"];
var _e = {
  key: 0,
  class: "vs__no-options"
};
var Oe = createTextVNode(" Sorry, no matching options. ");
var we = ["id"];
