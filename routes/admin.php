...
use App\Http\Controllers\Admin\GuestOrderController as AdminGuestOrderController;
...
Route::name('admin.')->group(function () {
    ...
    Route::middleware(['auth', 'checkPermission'])->group(function () {
        ...
        Route::controller(ShopController::class)->group(function () {
            ...
            // admin.shop.update_user
            Route::post('/shop/user/update/{user}', 'updateShopUser')->name('shop.update_user');

            // updateShopInfo
            Route::post('/shop/{shop}/update-info', 'updateShopInfo')->name('shop.update_info');
        });
        ...
        // Guest Orders (direct orders without registration)
        Route::get('/guest-orders', [AdminGuestOrderController::class, 'index'])->name('guest-orders.index');
        ...
        Route::controller(PageController::class)->group(function () {
            ...
            Route::put('/page/{page}/update', 'update')->name('page.update');
