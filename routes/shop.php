...
use App\Http\Controllers\Shop\GuestOrderController as ShopGuestOrderController;
...
Route::name('shop.')->group(function () {
    ...
    Route::middleware(['authShop', 'checkPermission'])->group(function () {
        ...
        // Guest Orders (direct orders for this shop)
        Route::get('/guest-orders', [ShopGuestOrderController::class, 'index'])->name('guest-orders.index');
        Route::get('/guest-orders/{guestOrder}', [ShopGuestOrderController::class, 'show'])->name('guest-orders.show');
        Route::get('/guest-orders/{guestOrder}/invoice', [ShopGuestOrderController::class, 'invoice'])->name('guest-orders.invoice');
        Route::post('/guest-orders/{guestOrder}/status', [ShopGuestOrderController::class, 'updateStatus'])->name('guest-orders.update-status');
        ...
        // Province Delivery Charges
        Route::controller(\App\Http\Controllers\Shop\ProvinceDeliveryChargeController::class)->group(function () {
            Route::get('/province-delivery-charges', 'index')->name('province_delivery_charges.index');
            Route::get('/province-delivery-charges/create', 'create')->name('province_delivery_charges.create');
            Route::post('/province-delivery-charges', 'store')->name('province_delivery_charges.store');
            Route::get('/province-delivery-charges/{id}/edit', 'edit')->name('province_delivery_charges.edit');
            Route::put('/province-delivery-charges/{id}', 'update')->name('province_delivery_charges.update');
            Route::delete('/province-delivery-charges/{id}', 'destroy')->name('province_delivery_charges.destroy');
        });
    });
});
