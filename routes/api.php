...
use App\Http\Controllers\AI\SmartSearchController;
...
use App\Http\Controllers\API\ProvincesDeliveryChargesController;
...
Route::post('/guest/place-order', [GuestOrderController::class, 'place']);
...
Route::controller(CategoryController::class)->group(function () {
    ...
    Route::get('/categories-by-shop', 'getCategoriesByShop'); // <-- اضفتها هنا
});
...
Route::controller(ProductController::class)->group(function () {
    ...
    Route::get('/products/discounted', 'discounted');
...
Route::controller(ShopController::class)->group(function () {
    ...
    Route::get('/shops/{shop}/categories', 'shopCategories');
...
// Province delivery charges for shop
Route::get('/shop/{shopId}/provinces-delivery-charges', [ProvincesDeliveryChargesController::class, 'getProvincesDeliveryCharges']);

// AI Routes
Route::prefix('ai')->middleware(['web'])->group(function () {
    // Smart Search Routes
    Route::get('/smart-search', [SmartSearchController::class, 'smartSearch']);
    Route::get('/search-suggestions', [SmartSearchController::class, 'searchSuggestions']);
    Route::post('/analyze-search-results', [SmartSearchController::class, 'analyzeSearchResults']);
    
    // Sentiment Analysis Routes
    Route::post('/analyze-sentiment', [SentimentController::class, 'analyzeText']);
    Route::get('/product/{productId}/sentiment', [SentimentController::class, 'analyzeProductSentiment']);
    Route::post('/analyze-all-reviews', [SentimentController::class, 'analyzeAllReviews']);
    Route::get('/sentiment-stats', [SentimentController::class, 'getSentimentStats']);
    
    // ChatBot Routes
    Route::post('/chat/send', [ChatBotController::class, 'sendMessage']);
    Route::post('/chat/clear', [ChatBotController::class, 'clearHistory']);
    Route::get('/chat/export', [ChatBotController::class, 'exportHistory']);
    Route::get('/chat/stats', [ChatBotController::class, 'getStats']);
    Route::get('/chat/search', [ChatBotController::class, 'searchHistory']);
});
