...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        // get all active brands, colors, units, sizes (no shop_id filter)
        $brands = \App\Models\Brand::isActive()->get();
        $colors = \App\Models\Color::isActive()->get();
        
        // get categories assigned to this shop
        $categories = \App\Models\Category::whereHas('shops', function ($query) use ($shopId) {
            $query->where('shop_id', $shopId);
        })->active()->get();
        
        $units = \App\Models\Unit::isActive()->get();
        $sizes = \App\Models\Size::isActive()->get();
    ...
    public function edit(Product $product)
    {
        ...
        // get subcategories that belong to categories assigned to this shop
        $subCategories = SubCategory::whereHas('categories', function ($query) use ($shopId) {
            $query->whereHas('shops', function ($shopQuery) use ($shopId) {
