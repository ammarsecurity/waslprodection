        ...
        <form @submit.prevent="addressFormSubmit()">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" id="name" v-model="formData.name" :placeholder="$t('Enter name')"
                        class="form-input" :class="(errors && errors?.name) ? 'border-red-500' : 'border-slate-200'">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-1 gap-6 mt-6">
                <div>
                    ...
                    <input type="text" id="Area" :placeholder="$t('Enter Area')" class="form-input"
                        v-model="formData.area" :class="errors && errors?.area ? 'border-red-500' : 'border-slate-200'">
            ...
            <div class="mt-4">
                ...
                <div class="flex justify-between items-center gap-2 mt-6">
                    ...
                    <button v-else type="button" class="px-4 py-3 md:px-6 md:py-4 bg-primary-200 text-primary text-sm md:text-base rounded-[10px] flex justify-center items-center gap-1" disabled>
