            ...
            <Popover v-slot="{ open }">
                ...
                <transition enter-active-class="transition ease-out duration-200"
                    ...
                    <PopoverPanel class="absolute pb-6 left-0 right-0 z-10 mt-0 flex main-container">
                        <PopoverButton as="div" class="w-screen p-6 bg-white shadow-md grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-7 xl:grid-cols-10 gap-4 rounded-br-xl rounded-bl-xl max-h-[500px] overflow-y-auto">
