        ...
        <div class="main-container flex justify-between items-center py-2 text-white">
            ...
            <div class="flex items-center gap-3">
                <Menu as="div" class="relative inline-block text-left">
                    <div>
                        <MenuButton
                            class="inline-flex items-center text-white  gap-1 text-sm font-normal leading-tight justify-between">
                ...
                <Menu as="div" class="relative inline-block text-left">
                    <div>
                        <MenuButton
                            class="inline-flex items-center text-white  gap-1 text-sm font-normal leading-tight">
                            {{ currentLanguage }}
                            <ChevronDownIcon class="w-4 h-4" aria-hidden="true" />
                        </MenuButton>
                    </div>
