<template>
    <div class="main-container py-12">
        ...
        <div v-if="!isLoading" class="flex justify-between items-center gap-4">
            <div class="text-slate-800 text-lg md:text-3xl font-bold leading-9">{{ $t('Discounted Products') }}</div>

            <router-link to="/discounted-products" class="flex items-center gap-1">
