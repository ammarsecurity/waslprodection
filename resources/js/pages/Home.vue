<template>
    <div>
        ...
        <NewProducts  v-if="newProducts.length" :products="newProducts" :isLoading="isLoading" />
      
        <DiscountedProducts v-if="discountedProducts.length" :products="discountedProducts" :isLoading="isLoading" />
...
const getData = () => {
    ...
    newProducts.value = response.data.data.new_products || [];
    discountedProducts.value = response.data.data.discounted_products || [];
