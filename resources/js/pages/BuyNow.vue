...
onMounted(async () => {
    ...
    // Initialize shop data and provinces for buy now product
    if (basketStore.buyNowProduct) {
        const shopId = basketStore.buyNowProduct.shop_id;
        form.shop_ids = [shopId];
        
        // Fetch provinces for the shop
