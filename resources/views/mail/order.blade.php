                                        ...
                                        <tbody>
                                            ...
                                            @if($order->province_name || $order->province_area || $order->nearest_landmark)
                                                ...
                                                <tr>
                                                    <td
                                                        style="width: 100%; font-size: 14px; line-height: 18px; color: #666666;">
                                                        <strong>Area:</strong> {{ $order->province_area }}
                                                    </td>
                                                </tr>
                                                @endif
                                                ...
                                                <tr>
                                                    <td
                                                        ...
                                                        <strong>Landmark:</strong> {{ $order->nearest_landmark }}
                                                    </td>
                                                </tr>
                                                @endif
                                            @else
                                                {{-- Fallback to old address fields --}}
                                                <tr>
                                                    <td
                                                        style="width: 100%; font-size: 14px; line-height: 18px; color: #666666;">
                                                        {{ $order->address?->name }}
