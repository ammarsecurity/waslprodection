@extends('layouts.app')
@section('header-title', __('Create New FlashSale'))

@section('content')
    <div class="page-title">
        <div class="d-flex gap-2 align-items-center">
            <i class="fa-solid fa-bolt"></i> {{ __('Create New FlashSale') }}
        </div>
    </div>
        ...
        <div class="card mt-3">
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-8">
                        <div>
                            <x-input label="Name" name="name" type="text" :placeholder="__('Enter name')"
                                required="true" />
                        </div>

                        <div class="mt-3">
                            <x-input label="Minimum Discount" onlyNumber="true" name="discount" type="text" required="true" :placeholder="__('Enter minimum discount')" />
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 mb-3">
                                <x-input type="time" id="timepicker2" label="End Time" name="end_time" required="true" />
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <label for="thumbnail" class="flashSaleThumbnail">
                            <img src="https://placehold.co/600x400/f1f5f9/png" id="preview" alt="" width="100%">
                        </label>
