...
{{-- Guest Orders --}}
<li>
    <a class="menu {{ $request->routeIs('shop.guest-orders.index') ? 'active' : '' }}"
        href="{{ route('shop.guest-orders.index') }}">
        <span>
            <img class="menu-icon" src="{{ asset('assets/icons-admin/shopping-cart-check.svg') }}" alt="icon" loading="lazy" />
            {{ __('Guest Orders') }}
        </span>
    </a>
</li>
...
<li>
    <a class="menu {{ $request->routeIs('shop.province_delivery_charges.*') ? 'active' : '' }}"
        href="{{ route('shop.province_delivery_charges.index') }}">
        <span>
            <img class="menu-icon" src="{{ asset('assets/icons-admin/boxes.svg') }}" alt="icon" loading="lazy" />
            {{ __('Delivery Charges by Province') }}
        </span>
    </a>
</li>
...
@hasPermission('shop.color.index')
    ...
    <li>
        <a class="menu {{ $request->routeIs('shop.color.*') ? 'active' : '' }}" href="{{ route('shop.color.index') }}">
            <span>
                <img class="menu-icon" src="{{ asset('assets/icons-admin/color.svg') }}" alt="icon"
                    loading="lazy" />
                {{ __('Color') }}
            </span>
        </a>
...
@hasPermission('shop.size.index')
    ...
    <li>
        <a class="menu {{ $request->routeIs('shop.size.*') ? 'active' : '' }}" href="{{ route('shop.size.index') }}">
            <span>
                <img class="menu-icon" src="{{ asset('assets/icons-admin/sizes.svg') }}" alt="icon"
                    loading="lazy" />
                {{ __('Sizes') }}
            </span>
        </a>
