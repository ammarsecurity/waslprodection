...
@section('content')
    <div class="d-flex align-items-center flex-wrap gap-3 justify-content-between px-3">
        ...
        <button type="button" class="btn py-2 btn-primary" data-bs-toggle="modal" data-bs-target="#requestSubCategoryModal">
            <i class="fa fa-plus-circle"></i>
            {{__('Request New Sub Category')}}
        </button>
    </div>
    ...
    <div class="modal fade" id="requestSubCategoryModal" tabindex="-1" aria-labelledby="requestSubCategoryModalLabel" aria-hidden="true" dir="rtl">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="requestSubCategoryModalLabel">{{ __('Request New Sub Category') }}</h5>
                ...
                <div class="modal-body text-center">
                    <div class="mb-4">
                        ...
                        <h4>{{ __('Sub Category Request') }}</h4>
                        <p class="text-muted">{{ __('To add a new sub category, please contact the administration team.') }}</p>
                    </div>
                    ...
                    <div class="mt-3 text-right">
                        ...
                        <ul class="list-unstyled">
                            <li class="d-flex align-items-center mb-2">
                                <span class="me-2">{{ __('Parent Category') }}</span>
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="text-success">
                                    <path d="M20 6L9 17L4 12" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                            </li>
                            <li class="d-flex align-items-center mb-2">
                                <span class="me-2">{{ __('Sub Category name') }}</span>
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="text-success">
                                    <path d="M20 6L9 17L4 12" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                            </li>
                            <li class="d-flex align-items-center mb-2">
                                <span class="me-2">{{ __('Sub Category description') }}</span>
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="text-success">
                                    <path d="M20 6L9 17L4 12" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                            </li>
                            <li class="d-flex align-items-center">
                                <span class="me-2">{{ __('Sub Category image (optional)') }}</span>
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="text-success">
                                    <path d="M20 6L9 17L4 12" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                            </li>
                ...
                <div class="modal-footer">
                    ...
                    <a href="https://wa.me/9647830200030?text={{ urlencode(__('Hello, I would like to request a new sub category for my shop. Please provide the following information:') . ' ' . __('Parent Category') . ', ' . __('Sub Category name') . ', ' . __('Sub Category description') . ', ' . __('Sub Category image (optional)')) }}" 
