    ...
    <form action="{{ route('shop.product.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="">
                    <x-input label="Product Name" name="name" type="text" placeholder="{{ __('Enter Product Name') }}"
                        required="true" />
                </div>
                ...
                <div class="mt-3">
                    ...
                    <textarea required name="short_description" class="form-control @error('short_description') is-invalid @enderror"
                        rows="2" placeholder="{{ __('Enter short description') }}">{{ old('short_description') }}</textarea>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-4 mt-3 mt-md-0">
                                ...
                                <select name="sub_category[]" data-placeholder="{{ __('Select Sub Category') }}"
                            ...
                            <div class="col-md-6 col-lg-4 mt-3 mt-md-0">
                                <x-select label="{{ __('Select Brand') }}" name="brand">
                                    <option value="">
                                        {{ __('Select Brand') }}
                                    </option>
                            ...
                            <div class="col-md-6 col-lg-4 mt-4">
                                ...
                                <select name="colorIds[]" data-placeholder="{{ __('Select Color') }}" class="form-control colorSelect"
                            ...
                            <div class="col-lg-4 col-md-6 mt-4">
                                <x-select label="{{ __('Select Unit') }}" name="unit" placeholder="{{ __('Select Unit') }}">
                                    <option value="">
                                        {{ __('Select Unit') }}
                                    </option>
                            ...
                            <div class="col-md-6 col-lg-4 mt-4">
                                ...
                                <select name="sizeIds[]" data-placeholder="{{ __('Select Size') }}" class="form-control sizeSelector"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 mt-3">
                                <x-input type="text" name="agent_price" label="{{ __('Agent Price') }} ({{ __('Optional') }})"
                                    placeholder="{{ __('Agent Price') }}" onlyNumber="true" />
